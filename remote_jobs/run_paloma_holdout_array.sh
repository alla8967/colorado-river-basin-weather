#!/bin/bash
# Purpose: Submit standard-memory Paloma station-holdout chunk jobs as a Slurm array.
...
# sbatch --array=1-27 remote_jobs/run_paloma_holdout_array.sh
#SBATCH --array=1-1
#SBATCH --output=remote_jobs/logs/paloma-holdout.%A_%a.out
#SBATCH --error=remote_jobs/logs/paloma-holdout.%A_%a.err
...
CHUNK="weather_reconstruction_model/outputs/paloma/station_holdout_chunks/${VARIABLE}/chunk_${CHUNK_ID}.csv"
