...
#SBATCH --array=1-3
#SBATCH --output=remote_jobs/logs/paloma-export.%A_%a.out
#SBATCH --error=remote_jobs/logs/paloma-export.%A_%a.err
...
python weather_reconstruction_model/scripts/export_final_model_artifact.py \
  ...
  --training-strategy chunked-forest \
  --chunk-rows 100000 \
