...
# sbatch --array=1-77%3 remote_jobs/run_paloma_holdout_array_highmem.sh
#SBATCH --array=1-1
#SBATCH --output=remote_jobs/logs/paloma-holdout-hm.%A_%a.out
#SBATCH --error=remote_jobs/logs/paloma-holdout-hm.%A_%a.err
