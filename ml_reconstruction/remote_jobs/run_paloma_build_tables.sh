...
#SBATCH --array=1-3
#SBATCH --output=ml_reconstruction/remote_jobs/logs/paloma-tables.%A_%a.out
#SBATCH --error=ml_reconstruction/remote_jobs/logs/paloma-tables.%A_%a.err
...
mkdir -p "$DURABLE_PROJECT_DIR/ml_reconstruction/weather_reconstruction_model/outputs/general_training_tables"
rsync -av \
  "ml_reconstruction/weather_reconstruction_model/outputs/general_training_tables/${TABLE_STEM}.csv" \
  "$DURABLE_PROJECT_DIR/ml_reconstruction/weather_reconstruction_model/outputs/general_training_tables/"
