...
#SBATCH --output=ml_reconstruction/remote_jobs/logs/paloma-merge.%j.out
#SBATCH --error=ml_reconstruction/remote_jobs/logs/paloma-merge.%j.err
...
OUTPUT="ml_reconstruction/weather_reconstruction_model/outputs/paloma/paloma_v1_${VARIABLE}_station_holdout_master.csv"

python ml_reconstruction/weather_reconstruction_model/scripts/merge_station_holdout_results.py \
  --input-dir ml_reconstruction/weather_reconstruction_model/outputs/reports \
...
rsync -av ml_reconstruction/weather_reconstruction_model/outputs/paloma/ \
  "$DURABLE_PROJECT_DIR/model_runs/paloma_v1/validation/"
rsync -av ml_reconstruction/remote_jobs/logs/ \
