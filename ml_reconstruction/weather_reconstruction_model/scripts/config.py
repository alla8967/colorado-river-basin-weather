...
DATA_DIR = PROJECT_DIR / "ml_reconstruction" / "NOAA_Inventory_Sort"
OUTPUT_DIR = PROJECT_DIR / "ml_reconstruction" / "weather_reconstruction_model" / "outputs"
CACHE_DIR = PROJECT_DIR / "ml_reconstruction" / "weather_reconstruction_model" / "cache"
MODEL_RUN_DIR = PROJECT_DIR / "ml_reconstruction" / "weather_reconstruction_model" / "model_runs"
...
TERRAIN_FEATURE_FILE = (
    PROJECT_DIR / "ml_reconstruction" / "terrain_data" / "processed" / "station_terrain_features.csv"
)
