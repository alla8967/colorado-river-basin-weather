...
IMPORTANT_SCRIPTS = [
    config.PROJECT_DIR / "ml_reconstruction/weather_reconstruction_model" / "scripts" / "build_weather_cache.py",
    config.PROJECT_DIR / "ml_reconstruction/weather_reconstruction_model" / "scripts" / "build_station_terrain_features.py",
    config.PROJECT_DIR / "ml_reconstruction/weather_reconstruction_model" / "scripts" / "build_general_training_table.py",
    config.PROJECT_DIR / "ml_reconstruction/weather_reconstruction_model" / "scripts" / "train_tree_temperature_model.py",
    config.PROJECT_DIR / "ml_reconstruction/weather_reconstruction_model" / "scripts" / "train_station_holdout_model.py",
]
...
def audit_large_outputs(threshold_mb: float) -> None:
    output_roots = [
        config.OUTPUT_DIR,
        config.CACHE_DIR,
        config.PROJECT_DIR / "ml_reconstruction/terrain_data" / "processed",
    ]
    large_files = []
