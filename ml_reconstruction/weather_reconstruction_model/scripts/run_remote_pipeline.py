...
def build_table_command(
    ...
    command = [
        sys.executable,
        "ml_reconstruction/weather_reconstruction_model/scripts/build_general_training_table.py",
        "--limit",
...
def build_pairwise_skill_command(
    ...
    return [
        sys.executable,
        "ml_reconstruction/weather_reconstruction_model/scripts/build_pairwise_station_skill_features.py",
        "--target-limit",
        str(preset.build_limit),
        "--target-neighbor-prefilter-count",
        str(preset.target_neighbor_prefilter_count),
...
def holdout_command(
    ...
    command = [
        sys.executable,
        "ml_reconstruction/weather_reconstruction_model/scripts/train_station_holdout_model.py",
        str(general_table),
        "--predict-offset-from-baseline",
        "--variable",
        variable,
