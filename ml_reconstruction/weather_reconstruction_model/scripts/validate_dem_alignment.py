...
REPORT_DIR = PROJECT_DIR / "ml_reconstruction/terrain_data" / "processed"
...
try:
    ...
    print("For example: .venv/bin/python ml_reconstruction/weather_reconstruction_model/scripts/validate_dem_alignment.py")
    print()
