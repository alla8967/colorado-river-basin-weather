...
TERRAIN_OUTPUT_DIR = PROJECT_DIR / "terrain_data" / "processed"
...
try:
    ...
    print("For example: .venv/bin/python weather_reconstruction_model/scripts/build_station_terrain_features.py")
    print()
